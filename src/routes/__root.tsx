    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-md bg-accent-fill px-4 py-2 text-sm font-medium text-primary-foreground transition-colors hover:bg-accent-press"
          >
            Go home
          </Link>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Q-Salon Suite — Salon Management for Qatar" },
      {
        ...
        content:
          "Run appointments, staff, stock and revenue across every branch of your salon brand.",
      },
    ...
    links: [
      { rel: "stylesheet", href: appCss },
      {
        rel: "icon",
        type: "image/png",
        href: "/__l5e/assets-v1/cbd9df57-6291-4a0b-8176-2aa1883ca046/q-salon-logo.png",
      },
      { rel: "preconnect", href: "https://fonts.googleapis.com" },
      { rel: "preconnect", href: "https://fonts.gstatic.com", crossOrigin: "" },
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;0,700;1,400;1,600&family=Karla:wght@300;400;500;600;700&family=Caveat:wght@400;500&display=swap",
      },
    ],
  }),
